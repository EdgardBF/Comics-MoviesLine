    ...
    public static function header($title){
        ...
        if(isset($_SESSION['usuario']))
        {
            ...
            print("
                    ...
                    <nav class='tipografia'>
                        <div class='nav-wrapper #00838f cyan darken-3'>
                            ...
                            <ul class='right hide-on-med-and-down'>
                                ...
                                <li class='$activo4'><a href='../dashboard/main_public/login.php' class='dropdown-button texto' data-activates='dropdown'><i class='material-icons left'>person</i>".$_SESSION['usuario']."</a></li>
                ...
                <li class='$activo4'><a class='texto dropdown-button'><i class='material-icons left white-text'>person</i>".$_SESSION['usuario']."</a></li>
