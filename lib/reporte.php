...
$sql1 = "SELECT productos.nombre_producto, productos.precio_producto, compra.cantidad FROM productos, registro, compra WHERE productos.id_producto = compra.id_producto AND registro.id_registro = compra.id_registro AND registro.id_registro = ? AND compra.fecha = ? AND id_reconocimiento = ?";
$id = $_GET['id'];
$params2 = array($id, $fes, $reco);
