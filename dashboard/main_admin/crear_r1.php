...
else
{
    ...
    <label class = 'tamaño'>Ingrese fecha</label>
        ...
        <a href='../../lib/reportes3.php?ini=".$inicio."' class='waves-effect waves-light tooltipped' data-position='bottom' data-delay='50' data-tooltip='ver reporte de doctores de la especialidad'><i class='material-icons cyan-text text-darken-3'>description</i></a>");
        }
        else
        {
             print("
             Las fechas que se usaran para generar el reporte es de: ".$inicio1." a ".$fin1."<br>
             <a href='../../lib/reportes3.php?ini=' class='waves-effect waves-light tooltipped' data-position='bottom' data-delay='50' data-tooltip='ver reporte de doctores de las refrencias'><i class='material-icons cyan-text text-darken-3'>description</i></a>");
        }
        ?>
        </div>
	</div>
